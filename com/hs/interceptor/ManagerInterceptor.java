...
public class ManagerInterceptor implements HandlerInterceptor {
    ...
    Logger logger=Logger.getLogger(ManagerInterceptor.class);
    @Override
    public boolean preHandle(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object o) throws Exception {
        logger.info("进入部门经理权限拦截器");
        //获取session
        ...
        if (obj!=null){
            ...
            if (accountVO.getEmployeeVO().getRole().getRid()!=1||accountVO.getEmployeeVO().getRole().getRid()==3){
                return true;
            }else {
                logger.info("权限不够");
            }
